...
# Parsing + Configuration Script – IG902 - Rev. A

This **Parsing + Configuration** script is designed for the **IG902** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – IG902 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **IG902** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
